...
public class AESCommon {
    ...
    public static final int KEY_128_BITS = 16;
    public static final int KEY_192_BITS = 24;
    public static final int KEY_256_BITS = 32;
     ...
     * @implNote Generate with generateSboxInv();
     */
    ...
    /**
     * Generate sbox inverted from sbox
     */
    public static void generateSboxInv() {
        sboxInv = new byte[256];
        for (int i = 0; i < 256; i++) {
            sboxInv[sbox[i] & 0xFF] = (byte) i;
        }
    }

    public static byte getSboxValue(int index){
        return sbox[index];
    }

    public static byte getSboxInvValue(int index){
        return sboxInv[index];
    }

    public static byte getRconValue(int index){
        return rcon[index];
    }
